...
export default {
  ...
  ai: {
    ...
    agentPermissionLabel: 'Agent command permission',
    agentPermissionAsk: 'Ask every time',
    agentPermissionAskDescription: 'Ask for your approval before every command',
    agentPermissionReadOnly: 'Auto-run queries',
    agentPermissionReadOnlyDescription: 'Run read-only commands directly and ask before changes',
    agentPermissionFull: 'Full auto (high risk)',
    agentPermissionFullDescription: 'Run commands without approval; dangerous-command safety rules still apply',
    agentPermissionUpdateFailed: 'Permission mode update failed',
    agentPermissionUpdateFailedDescription: 'Agent will keep using the previous command permission mode',
    localhost: 'Localhost',
    newChat: 'New Chat',
