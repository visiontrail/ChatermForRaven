...
export default {
  ...
  ai: {
    ...
    agentPermissionLabel: 'Agent 命令权限',
    agentPermissionAsk: '逐次确认',
    agentPermissionAskDescription: '每条命令执行前都需要你的确认',
    agentPermissionReadOnly: '查询自动执行',
    agentPermissionReadOnlyDescription: '查询类命令直接执行，修改类命令仍需确认',
    agentPermissionFull: '全自动（高风险）',
    agentPermissionFullDescription: '所有命令无需确认；危险命令安全规则仍然生效',
    agentPermissionUpdateFailed: '权限模式更新失败',
    agentPermissionUpdateFailedDescription: 'Agent 将继续使用之前的命令权限模式',
    localhost: '本地主机',
    newChat: '新建对话',
